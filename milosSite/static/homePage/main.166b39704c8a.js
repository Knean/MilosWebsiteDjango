...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm5/http.js");
...
/* harmony import */ var _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @angular/material/toolbar */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/toolbar.js");
...
/* harmony import */ var _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @angular/material/sidenav */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/sidenav.js");
...
/* harmony import */ var _angular_material_card__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @angular/material/card */ "./node_modules/@angular/material/__ivy_ngcc__/fesm5/card.js");
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        ...
        var csrfheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'X-CSRFToken': csrf });
    ...
    AuthenticationService.prototype.logout = function () {
        ...
        this.http.get(this.getHost() + "auth/logout/")
            .subscribe(function () {
            _this.get_user(); // this.refreshCart()
        });
    };
    ...
    AuthenticationService.prototype.getCookie = function (name) {
    ...
    AuthenticationService.prototype.getHost = function () {
...
var DataReceptionService = /** @class */ (function () {
    ...
    DataReceptionService.prototype.getSocketPath = function () {
    ...
    DataReceptionService.prototype.createConnection = function () {
        var _this = this;
        ...
        socket.onmessage = function (event) {
            _this.tree_data.next(JSON.parse(event.data));
            //update.apply(this)
        };
        ...
        taskSocket.onmessage = function (event) {
            _this.task_data.next(JSON.parse(event.data));
            //update.apply(this)
        };
    };
...
function HomepageComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomepageComponent_div_1_Template_button_click_5_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.openDialog(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomepageComponent_div_1_Template_button_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.openRegDialog(); });
...
function HomepageComponent_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "mat-menu", 10, 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "button", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomepageComponent_ng_template_2_Template_button_click_5_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.logout(); });
...
var HomepageComponent = /** @class */ (function () {
    ...
    HomepageComponent.prototype.dostuff = function () {
    ...
    HomepageComponent.prototype.ngOnInit = function () {
        ...
        this.reload.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounce"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(500); })).subscribe(function () {
            // d3.selectAll(".genericClass").select("svg").remove();
            console.log("reload after debounce");
            _this.allTrees.forEach(function (tree, index) { return _this.renderTree(tree, index); });
        });
        this.dataSubscription = this.data_service.tree_data.subscribe(function (result) {
            _this.allTrees = result.sort(function (a, b) { return b.length - a.length; });
            if (result.length > 0) {
                console.log("data arrived ");
                _this.reload.next("reload baby");
            }
        });
        ...
        this.auth.userList.subscribe(function (dataResponse) {
            _this.users = dataResponse;
        });
    };
    HomepageComponent.prototype.selectTab = function (index) {
        this.tabs.forEach(function (tab) { return tab.selected = false; });
        this.tabs[index].selected = true;
        //this.loading= false;
    };
    HomepageComponent.prototype.renderTree = function (data, index) {
        ...
        try {
            ...
            svg.append(function () { return graph.node(); }).attr('transform', function (d) { return "translate(" + 10 + ", " + 15 + ")"; });
        }
        catch (_a) {
        }
    };
    HomepageComponent.prototype.delete = function () {
        this.purchase.reset();
    };
    ...
    HomepageComponent.prototype.nameFunction = function () {
        return "a name";
    };
    HomepageComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.data_service.task_data.subscribe(function (result) {
            _this.task = result;
    ...
    HomepageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomepageComponent, selectors: [["app-homepage"]], hostBindings: function HomepageComponent_HostBindings(rf, ctx) { if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", ctx.allTrees);
        } }, directives: [_angular_material_toolbar__WEBPACK_IMPORTED_MODULE_11__["MatToolbar"], _angular_common__WEBPACK_IMPORTED_MODULE_12__["NgIf"], _angular_material_button__WEBPACK_IMPORTED_MODULE_13__["MatButton"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_14__["MatProgressSpinner"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_15__["MatIcon"], _angular_common__WEBPACK_IMPORTED_MODULE_12__["NgForOf"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_16__["MatMenuTrigger"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_16__["_MatMenu"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_16__["MatMenuItem"]], styles: [".tab_item[_ngcontent-%COMP%]{\r\n  flex-grow: 1;\r\n  flex-shrink: 1;\r\n\r\n  background-color:rgb(159, 159, 159) ;\r\n\r\n}\r\n\r\n.tab_item_selected[_ngcontent-%COMP%]{\r\n  background:white;\r\n}\r\n\r\n.tab_bar[_ngcontent-%COMP%]{\r\n  display: flex;\r\n  justify-content: space-around\r\n}\r\n\r\n.content[_ngcontent-%COMP%]{\r\n  display: none\r\n}\r\n\r\n.selected[_ngcontent-%COMP%]{\r\n  display: block\r\n}\r\n\r\n.hidden[_ngcontent-%COMP%]{\r\n  display: none\r\n}\r\n\r\n.loaderHolder[_ngcontent-%COMP%]{\r\n\r\n  display:flex;\r\n  align-items: center;\r\n  height: 65vh;\r\n\r\n}\r\n\r\n.progressClass[_ngcontent-%COMP%]{\r\n  height: 100%\r\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
var PurchaseService = /** @class */ (function () {
    ...
    PurchaseService.prototype.purchase = function (amount) {
...
var PurchaseComponent = /** @class */ (function () {
    ...
    PurchaseComponent.prototype.save = function (amount) {
    ...
    PurchaseComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PurchaseComponent, selectors: [["app-purchase"]], decls: 13, vars: 1, consts: [[1, "example-form"], [1, "example-full-width"], ["matInput", "", "maxlength", "256", "type", "number", "placeholder", "999"], ["message", ""], ["align", "start"], ["align", "end"], ["mat-raised-button", "", 3, "disabled", "click"]], template: function PurchaseComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PurchaseComponent_Template_button_click_11_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r1); var _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](5); return ctx.save(_r0.value); });
...
var TreeDirectiveDirective = /** @class */ (function () {
    function TreeDirectiveDirective(renderer, elementRef) {
        this.renderer = renderer;
        this.elementRef = elementRef;
    }
    TreeDirectiveDirective.prototype.ngOnInit = function () {
...
var TreeGeneratorService = /** @class */ (function () {
    function TreeGeneratorService() {
    }
    TreeGeneratorService.prototype.generateTree = function (users, data, width, height) {
        ...
        users = users.sort(function (a, b) { return a.username.localeCompare(b.username); });
        console.log(users, "users ");
        var graph = d3.create('svg:g');
        var scale;
        scale = d3.scaleOrdinal(d3["schemeSet3"])
            .domain(users.map(function (element) { return element.username; }));
        graph.selectAll('.node').remove();
        graph.selectAll('.link').remove();
        data.sort(function (a, b) { return a.number - b.number; });
        var even = data.filter(function (a) { return a.number % 2 == 0; }).sort(function (a, b) { return b.number - a.number; });
        var odd = data.filter(function (a) { return a.number % 2 == 1; }).sort(function (a, b) { return a.number - b.number; });
        ...
        links.enter().append('path')
            ...
            .attr('class', 'link')
            .attr('fill', 'none')
            .attr('stroke', function (d) { return d.target.data.hasOwnProperty('userName') ? scale(d.source.data.userName) : 'gray'; }) ////#aaa
            .attr('stroke-width', 2);
        ...
        var rectangles = enterNodes.append('rect')
            .attr('fill', function (d) { return d.userName != null ? scale(d.userName) : 'gray'; })
            .attr('stroke', 'black')
            .attr('width', 30) //30
            .attr('height', 30)
            .attr('transform', function (d) { return "translate(" + -5 + ", " + -10 + ")"; }).raise();
        ...
        enterNodes.append('text')
            ...
            .attr('fill', function (d) { return d.childrenMissing > 0 ? 'black' : "red"; })
            .attr('transform', function (d) { return "translate(" + 2 + ", " + 10 + ")"; });
...
var TreeComponent = /** @class */ (function () {
    ...
    TreeComponent.prototype.ngOnInit = function () {
        ...
        this.auth.userList.subscribe(function (dataResponse) {
            _this.users = dataResponse;
            console.log(_this.users, "this is the users data form subscription");
        });
    ...
    TreeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TreeComponent, selectors: [["app-tree"]], inputs: { data: "data", index: "index" }, decls: 2, vars: 0, consts: [[1, "container", 2, "float", "left", "width", "auto", "height", "auto"], [1, "canvas", 2, "border", "solid black"]], template: function TreeComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        } }, styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvdHJlZS90cmVlLmNvbXBvbmVudC5jc3MifQ== */"] });
