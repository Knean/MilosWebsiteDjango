    ...
    var HomepageComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomepageComponent, [{
        ...
        value: function dostuff() {
          ...
          setTimeout(function () {
            ...
            _this7.allTrees.forEach(function (tree, index) {
              return _this7.renderTree(_this7.allTrees[index], index);
            });
        ...
        value: function selectTab(index) {
          ...
          this.loading = true;
          setTimeout(function () {
            _this8.tabs.forEach(function (tab) {
              return tab.selected = false;
            });

            console.log(_this8.tabs[index].name);
            _this8.tabs[index].selected = true;
        ...
        value: function ngAfterViewInit() {
          ...
          this.data_service.tree_data.subscribe(function (result) {
            ...
            _this10.allTrees = result; //this.renderTree(this.allTrees[this.index])

            d3.selectAll("svg").remove();
            setTimeout(function () {
              result.forEach(function (tree, index) {
                return _this10.renderTree(_this10.allTrees[index], index);
              });
    ...
    var TreeComponent = /*#__PURE__*/function () {
      ...
      _createClass(TreeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.auth.userList.subscribe(function (dataResponse) {
            _this11.users = dataResponse;
            console.log(_this11.users, "this is the users data form subscription");
          });
